...
class App(QMainWindow):
    ...
    def __init__(self):
        ...
        self.dataplot1=MplCanvas(self,width=4,height=11,dpi=300)
        self.toolbar1=NavigationToolbar(self.dataplot1,self)
        self.dataplot2=MplCanvas(self,width=4,height=11,dpi=300)
        self.toolbar2=NavigationToolbar(self.dataplot2,self)
        self.dataplot3=MplCanvas(self,width=4,height=11,dpi=300)
        self.toolbar3=NavigationToolbar(self.dataplot3,self)
        
        self.layout=QGridLayout()
        self.box = QGroupBox()
        V1=QLabel("Enter the first vector")
        V2=QLabel("Enter the second vector")
        A=QLabel(r"Enter the angle (degrees)")
        V1L1=QLabel('Length Vector 1 (nm)')
        V1L2=QLabel('Length Vector 2 (nm)')
        V1A=QLabel(r'Angle (degrees)')
        V2L1=QLabel('Length Vector 1 (nm)')
        V2L2=QLabel('Length Vector 2 (nm)')
        V2A=QLabel(r'Angle (degrees)')
        V1.setAlignment(QtCore.Qt.AlignCenter)
        V2.setAlignment(QtCore.Qt.AlignCenter)
        A.setAlignment(QtCore.Qt.AlignCenter)
        V1L1.setAlignment(QtCore.Qt.AlignCenter)
        V1L2.setAlignment(QtCore.Qt.AlignCenter)
        V1A.setAlignment(QtCore.Qt.AlignCenter)
        V2L1.setAlignment(QtCore.Qt.AlignCenter)
        V2L2.setAlignment(QtCore.Qt.AlignCenter)
        V2A.setAlignment(QtCore.Qt.AlignCenter)
        
        self.V1L1 = QLineEdit()
        self.V1L2 = QLineEdit()
        self.V1Angle = QLineEdit()
        self.V2L1 = QLineEdit()
        self.V2L2 = QLineEdit()
        self.V2Angle = QLineEdit()
        self.A = QLineEdit()
        ...
        self.layout.addWidget(V1, 0,0,1,3) 
        self.layout.addWidget(V1L1,1,0,1,1)
        self.layout.addWidget(V1L2,1,1,1,1)
        self.layout.addWidget(V1A,1,2,1,1)
        self.layout.addWidget(self.V1L1,2,0,1,1)
        self.layout.addWidget(self.V1L2,2,1,1,1)
        self.layout.addWidget(self.V1Angle,2,2,1,1)
        self.layout.addWidget(V2,4,0,1,3)
        self.layout.addWidget(V2L1,5,0,1,1)
        self.layout.addWidget(V2L2,5,1,1,1)
        self.layout.addWidget(V2A,5,2,1,1)
        self.layout.addWidget(self.V2L1,6,0,1,1)
        self.layout.addWidget(self.V2L2,6,1,1,1)
        self.layout.addWidget(self.V2Angle,6,2,1,1)
        self.layout.addWidget(A,8,0,1,3)
        self.layout.addWidget(self.A,9,0,1,3)
        self.layout.addWidget(l_button, 10,0,1,3)
        self.layout.addWidget(self.MVa,11,0,1,2)
        self.layout.addWidget(self.MVb,11,2,1,2)
        self.layout.addWidget(self.MVamag,12,0,1,2)
        self.layout.addWidget(self.MVbmag,12,2,1,2)
        ...
        self.layout.addWidget(self.dataplot1,1,4,12,4)
        self.layout.addWidget(self.dataplot2,1,8,12,4)
        self.layout.addWidget(self.dataplot3,1,12,12,4)
    ...
    def calc_moire_vectors(self):
        V1L1=float(self.V1L1.text())
        V1L2=float(self.V1L2.text())
        V2L1=float(self.V2L1.text())
        V2L2=float(self.V2L2.text())
        A1=float(self.V1Angle.text())
        A2=float(self.V2Angle.text())
        R1=[[np.cos(A1*np.pi/180),-np.sin(A1*np.pi/180)],[np.sin(A1*np.pi/180),np.cos(A1*np.pi/180)]]
        R2=[[np.cos(A2*np.pi/180),-np.sin(A2*np.pi/180)],[np.sin(A2*np.pi/180),np.cos(A2*np.pi/180)]]
